  ...
  render() {
    ...
    return (
      <svg
        ...
        height={this.props.height ? this.props.height : ( this.props.width ? this.props.width / proportion : 1218)}
        width={this.props.width ? this.props.width : (this.props.height ? this.props.height * proportion : 4118)}>
       <g>
