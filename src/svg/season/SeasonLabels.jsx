  ...
  render: function() {
    return (
      <g id="labels" transform={'translate(5,-' + this.props.max + ')'}>
        <rect className="plan" x="0" y={(Number(this.props.max) / 10 - 25)} height="20" width="100" />
        <text className="graph_label" x="125" y={(Number(this.props.max) / 10 - 2)}>Text['total_plan']</text>
