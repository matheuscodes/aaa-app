...
var MUI = {
  ...
  // StepContent: require('material-ui/Stepper').StepContent,
...
MUI.palette = {}
MUI.palette.accent3Color = grey[600];
MUI.palette.darkAccent1Color = grey[500];
MUI.palette.darkAccent2Color = grey[700];
MUI.palette.darkAccent3Color = grey[900];
MUI.palette.primary1Color = yellow[700];
MUI.palette.primary2Color = yellow[800];
MUI.palette.accent1Color = red[600];
MUI.palette.pickerHeaderColor = yellow[600];
